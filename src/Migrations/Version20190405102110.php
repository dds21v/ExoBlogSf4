 ...
 */
final class Version20190405102110 extends AbstractMigration
{
    public function getDescription() : string
    {
        return 'bdd avec table + foreign keys';
    }
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE article ADD user_id INT NOT NULL, ADD category_id INT NOT NULL');
        $this->addSql('ALTER TABLE article ADD CONSTRAINT FK_23A0E66A76ED395 FOREIGN KEY (user_id) REFERENCES app_user (id)');
